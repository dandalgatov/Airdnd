...
class AmenitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amenity" do
    assert_difference('Amenity.count') do
      post amenities_url, params: { amenity: { category: @amenity.category, name: @amenity.name } }, as: :json
    end
  ...
  test "should update amenity" do
    patch amenity_url(@amenity), params: { amenity: { category: @amenity.category, name: @amenity.name } }, as: :json
    assert_response 200
  end
